  ...
  <div className="absolute top-[92px] left-0 w-full h-[474px] bg-[#172933]"></div>
      ...
      >
        ...
        <div className="w-full max-w-full md:max-w-[617px] text-white flex flex-col gap-6 text-center md:text-left">
          ...
          <p className="font-urbanist text-base md:text-[18px] font-medium leading-relaxed text-gray-200">
          ...
          >
            ...
            <div className="flex flex-col text-center sm:text-left">
              <span className="text-black font-semibold text-base md:text-[16px]">
                Get Instant Professional Advice
              </span>
              <span className="text-gray-700 text-sm md:text-[15px] flex flex-col sm:flex-row gap-1 sm:gap-2">
                Ready to Help:
